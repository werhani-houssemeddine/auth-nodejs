...
module.exports = async function (_email, _password) {
  try {
    ...
    if(!muchPassword) return { status: 401, body: { message: 'Email or Password are incorects' }};
